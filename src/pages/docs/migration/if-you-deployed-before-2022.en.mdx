...
A breaking change was introduced in 2022. Starting from [this announcement](https://github.com/Astear17/VercelDrive/discussions/215), you would not need to generate your own authentication tokens such as `client_id`, `client_secret`, etc.
