...
![Xem trước video](../_images/showcase/file-preview-video.png)

### Âm thanh

Tệp âm thanh phát trong trình chơi tích hợp với điều khiển phát tiêu chuẩn.

![Xem trước âm thanh](../_images/showcase/file-preview-audio.png)

### PDF

Tệp PDF hiển thị trong trình duyệt với hỗ trợ cuộn và phóng to.

![Xem trước PDF](../_images/showcase/file-preview-pdf.png)

### Tài liệu Office

Tệp Word, Excel và PowerPoint được xem trước bằng nhúng trình duyệt khi có hỗ trợ.

![Xem trước tài liệu Office](../_images/showcase/file-preview-office.png)

### Mã nguồn

Tệp mã nguồn hiển thị với tô sáng cú pháp.

![Xem trước mã nguồn](../_images/showcase/file-preview-code.png)
...
![Xem trước EPUB](../_images/showcase/file-preview-epub.png)

### URL Shortcut

Tệp URL shortcut hiển thị liên kết đích với tùy chọn mở liên kết.

![Xem trước URL](../_images/showcase/file-preview-url.png)
